...
class Edge:
    def __init__(self, u, v, low, capacity):
        self.u = u
        self.v = v
        self.low = low
        self.capacity = capacity
        self.diff = capacity - low
        self.flow = 0
...
class FlowGraph:
    ...
    def add_edge(self, from_, to, low, capacity):
        # Note that we first append a forward edge and then a backward edge,
        # so all forward edges are stored at even indices (starting from 0),
        # whereas backward edges are stored at odd indices.
        forward_edge = Edge(from_, to, low, capacity)
...
class CirculationProblem:
    ...
    def _input(self):
        ...
        for _ in range(edge_count):
            u, v, low, capacity = map(int, input().split())
            graph.add_edge(u - 1, v - 1, low, capacity)
    ...
    def findCirculation(self, graph, n, m):
        ...
        if flow != graph.D:
            ...
            for i in range(m):
                ...
                flows[i] = currForwardEdge.flow + currForwardEdge.low
            return True, flows
